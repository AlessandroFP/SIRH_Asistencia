...
public class SolicitudException  extends IncompleteConversationalState {

  public SolicitudException(){
      super();
  }

  public SolicitudException(String msg){
      super(msg);
  }

  public SolicitudException(BeanMensaje beanMensaje){
      super(beanMensaje);
  }
}